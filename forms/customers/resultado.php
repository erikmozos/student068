...
<section class="my-16 px-6">
    <div class="max-w-lg mx-auto p-8 bg-white shadow-lg rounded-lg text-center">
        ...
        ?>
        <a href="customers.php" class="mt-6 inline-block bg-yellow-500 text-white p-3 rounded-lg hover:bg-yellow-600 transition-colors">Volver al Menú de Gestión de Clientes</a>
    </div>
</section>
</body>
</html>
