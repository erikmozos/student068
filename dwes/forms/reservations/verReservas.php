...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['reservation_number'])) {
        ...
        $sql = "SELECT * FROM 068_resevations WHERE reservation_number = '$reservation_number'";
    ...
    if (isset($_POST['update'])) {
        ...
        $update_sql = "UPDATE 068_resevations SET date_in='$date_in', date_out='$date_out', number_of_customers='$number_of_customers', reservation_price='$reservation_price', extras='$extras' WHERE reservation_number='$reservation_number'";
